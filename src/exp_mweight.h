...
public:
    ...
    ~Exp_Mcoarse_Rot_significant_base();
    void init(int _nr_classes,int _exp_nr_dir,int _exp_nr_psi,int nr_images,int exp_nr_trans);
    void fini();
    ...
    // assign
    virtual void assignMcoarseSignificant(int iclass,int idir,int ipsi,std::vector<int>& iimage_trans,char value) = 0;
...
private:
    // nr_classes*exp_nr_dir*exp_nr_psi  nr_images*exp_nr_trans
...
public:
    ...
    void assignMcoarseSignificant(int iclass,int idir,int ipsi,std::vector<int>& iimage_trans,char value);
...
public:
    ...
    ~Exp_Mcoarse_Rot_significant_new();
    void init(int _nr_classes,int _nr_dir,int _nr_psi,int _nr_images,int _nr_trans,int do_local_searching);
    void fini();
    // exp_Mcoarse_significant
    void resetMcoarseSignificant();
    void allocMcoarseSignificant(int iclass,int idir,int ipsi);
