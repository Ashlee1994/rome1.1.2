...
void solveW(double *PHI,int K,int M,float *W,float *Y,int D){
	...
	int maxKM = K > M?K:M;
	float *B = (float*)_mm_malloc(sizeof(float)*maxKM*D,64);
	float *A = (float*)_mm_malloc(sizeof(float)*K*M,64);
...
void solveW(double *PHI,int K,int M,double *W,double *Y,int D){
	...
	int maxKM = K > M?K:M;
	double *B = (double*)_mm_malloc(sizeof(double)*maxKM*D,64);
	double *A = (double*)_mm_malloc(sizeof(double)*K*M,64);
...
void solveW(double *PHI,int K,int M,double *W,double *Y,int D,int cfm_num){
	...
	double *A = (double*)_mm_malloc(sizeof(double)*cfm_K*M,64);
	double *B = (double*)_mm_malloc(sizeof(double)*maxKM*D,64);
