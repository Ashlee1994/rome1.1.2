...
// debug flag
// #define DEBUG
    static double* alignedDoubleMalloc(size_t size,int align){return (double*)_mm_malloc(sizeof(double)*size,align);}
    static void alignedDoubleFree(double* &ptr){_mm_free(ptr);}
